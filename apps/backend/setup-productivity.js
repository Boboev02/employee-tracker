...
// ─── Backend: Productivity service ───────────────────────────
write('src/analytics/productivity.service.ts', `import { Injectable } from '@nestjs/common';
...
@Module({
  ...
  providers:   [AnalyticsService, ActiveTimeService, ProductivityService],
})
export class AnalyticsModule {}
`);

console.log('\n✅ Productivity backend created');

...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    ...
    if (localStorage.getItem('onboarded')) router.push('/dashboard');
  }, []);
  ...
  return (
    /* ── Outer shell: full viewport, scrollable, centred ── */
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-purple-50 overflow-y-auto">
      <div className="flex min-h-screen items-start justify-center px-4 py-12 sm:items-center sm:py-8">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8">
            ...
            {step === 0 && (
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-8 max-w-md mx-auto leading-relaxed">
                  Employee Tracker поможет вам отслеживать активность команды&nbsp;на Wildberries
                  и Ozon, управлять задачами и анализировать продуктивность.
                </p>

                {/* Feature cards — fixed height so text never clips */}
                <div className="grid grid-cols-3 gap-4 mb-8">
                  {[
                    ...
                    <div key={f.title}
                      className="bg-indigo-50 rounded-xl p-4 flex flex-col items-center text-center gap-2">
            ...
            {step === 1 && (
              <div>
                ...
                <div className="bg-gray-50 rounded-xl p-5 mb-5 flex flex-col gap-3">
                  {[
                    { label: 'Название',       value: 'Test Company' },
            ...
            {step === 4 && (
              <div className="text-center">
                ...
                <p className="text-gray-500 mb-8 max-w-md mx-auto leading-relaxed">
                  Employee Tracker настроен и готов к работе. Начните с дашборда —
                  там видна вся статистика организации.
                </p>
                ...
                <div className="grid grid-cols-2 gap-3 mb-8 text-left">
                  {[
                    ...
                    <button key={item.href}
                      ...
                      className="flex items-center gap-3 p-4 bg-gray-50 hover:bg-indigo-50 hover:border-indigo-200 border border-gray-100 rounded-xl transition-colors text-left">

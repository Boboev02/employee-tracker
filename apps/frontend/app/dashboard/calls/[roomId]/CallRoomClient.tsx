...
export default function CallRoomClient() {
  ...
  // Когда меняется раскладка (pin/unpin), <video> элемент для своего потока пересоздаётся
  // React'ом в другом месте дерева — нужно заново привязать srcObject к новому DOM-узлу
  useEffect(() => {

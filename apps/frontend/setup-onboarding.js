...
write('app/onboarding/page.tsx', `'use client';
...
// ─── Update login page to redirect new admins to onboarding ──
let loginPage = fs.readFileSync('app/login/page.tsx', 'utf8');
if (!loginPage.includes('onboarded')) {
...
console.log('\n✅ Onboarding created');
console.log('Preview: http://localhost:3000/onboarding');
